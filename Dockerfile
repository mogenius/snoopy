FROM docker.io/library/alpine:3.23.4 AS zig
...
FROM docker.io/library/rust:1.94.1 AS cargo-zigbuild

RUN cargo install cargo-zigbuild

FROM docker.io/library/rust:1.94.1 AS bpf-linker
