FROM docker.io/library/alpine:3.23.2 AS zig
...
FROM docker.io/library/rust:1.93.0 AS cargo-zigbuild

RUN cargo install cargo-zigbuild

FROM docker.io/library/rust:1.93.0 AS bpf-linker

RUN cargo install bpf-linker

FROM docker.io/library/rust:1.93.0 AS builder
